...
import { productos, FabricasService } from 'src/app/servicios/fabricas.service';
...
export class ListarProductosPage implements OnInit {
  ...
  ir() {
    this.route.navigate(['/tabs/fabricas1/agregar-producto', this.id, this.nombre])
  }

  listar_detalles(producto){
    this.route.navigate(['/tabs/fabricas1/listar-detalles',this.id_ruta,producto.id,producto.tipo])
  }
      ...
      buttons: [
        {
          ...
          icon: 'eye',
          handler: () => {
            this.navCtrl.navigateForward(['tabs/fabricas1/ver-producto',item])
          }
        },
        {
          text: 'Modificar',
          icon: 'create',
          handler: () => {
            this.navCtrl.navigateForward(['tabs/fabricas1/modificar-producto',item])
          }
        }, 
        {
